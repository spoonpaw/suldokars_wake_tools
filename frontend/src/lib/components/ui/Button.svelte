...
<button
  ...
  class="{baseClasses} {variantClasses[variant]} {sizeClasses[size]} relative"
  onclick={onclick}
>
  ...
  {#if loading}
    <svg class="absolute h-4 w-4 animate-spin" fill="none" viewBox="0 0 24 24" aria-hidden="true">
