...
export const LANGUAGES_DATA: LanguageDef[] = [
  { id: 'pidgin', name: 'Pidgin', family: 'Trade', description: 'Trade language spoken by almost all intelligent beings.', sampleNames: ['Sura', 'Onde', 'Gil', 'Kosmo', 'Sal', 'Stratah', 'Esh', 'Nira', 'Din'] },
  { id: 'vatori', name: 'Vatori', family: 'Imperial (New)', description: 'Also New Imperial. Language of the Vatori Empire.', sampleNames: ['Hinlam', 'Ana', 'Rita', 'Erns', 'Ricte', 'Heda', 'Van', 'Godlid', 'Horus'] },
  { id: 'old_imperial', name: 'Old Imperial', family: 'Imperial (dead/scholarly)', description: 'Dead, scholarly language — originally High Imperial.', note: 'Mostly read, not spoken. Used in archives and clergy.' },
  { id: 'hro_hro', name: 'Hro-hro', family: 'Horrom', description: 'Language of horroms.' },
  { id: 'shagadar', name: 'Shagadar', family: 'Northern rural / shadow cults', description: '"Darktounge." Northern rural language of ancient origin, also reported in shadow cults.', sampleNames: ['Ahk', 'Um-la Abut', 'Haxoh', 'Baltazar', 'Strax', 'Vezna'] },
  { id: 'tgaka', name: 'Tgaka', family: 'TGA (rare)', description: 'Language of the TGA, now rarely spoken but frequently found in ruins.', sampleNames: ['Sha', 'Nin', 'Iko', 'Unna', 'Hun', 'Feng', 'Mian', 'Ka'] },
  { id: 'katonga', name: 'Katonga', family: 'Southern blood', description: 'Also Hiligish, Rurr. Southern blood dialects descended from Tong.', sampleNames: ['Chiggarro', 'Pkena', 'Koto', 'Oskat', 'Hakla', 'Shekta', 'Tko'] },
  { id: 'slither', name: 'Slither', family: 'Ptilian / scavenger guild', description: 'A Ptilian language, also a techno-scavenger guild language.', sampleNames: ['Ssracht', 'Iss', 'Nessa', 'Elele', 'Yinsi', 'Vissla', 'Eshtalan'] },
  { id: 'al_gol', name: 'Al-Gol', family: 'Machine', description: 'Machine language known by droids, holids, and some mainframes.', sampleNames: ['Fortodo', 'Checkpoint', 'Awaito Pen', 'Io', 'Deall'] },
  { id: 'klsixla', name: "K'lsixla", family: 'Amphibious alien', description: 'Amphibious alien language (also names XLA-symbiotic bloods).', sampleNames: ['Glgllunbug', 'Lispinkluck', 'Hurrnumblib', 'Blop', 'Puddlam'] },
  { id: 'bugga', name: 'Bugga', family: 'Insectoid', description: 'Insectoid language.', sampleNames: ['Have My Leg', 'Straw to Stack', 'An-Tenna', 'Last One Out'] },
  { id: 'orug', name: 'Orug', family: 'Orug', description: 'Orug language.', sampleNames: ['Holly', 'Acorn', 'Aster', 'Clover', 'Grape', 'Hebe', 'Mallow', 'Nerine'] },
  { id: 'palp', name: 'Palp', family: 'Palp alien', description: 'Palp alien language.', note: 'Requires palps to speak — non-palp species cannot produce it.' },
  { id: 'aeonic', name: 'Æonic', family: 'Undeciphered', description: 'Undeciphered hieroglyphic language.', note: 'Written only — meaning lost, hieroglyphs survive in ruins.' },
  { id: 'fungal', name: 'Fungal', family: 'Great Mycelium', description: 'Language of The Great Mycelium.', note: 'Chemical / spore-based — non-vocal.' },
  { id: 'krypotkep', name: 'Krypotkep', family: 'Secret machine', description: 'Secret machine language.', note: 'Construct third-language pick only.', restriction: { lifeFormGroup: 'construct', thirdSlotOnly: true } },
  { id: 'thieves_cant', name: "Thieves' Cant", family: 'Secret guild', description: 'Secret guild language.', note: 'Picked up through underground contacts.' },
  { id: 'mime', name: 'Mime', family: 'Dimension travelers', description: 'Language of the Mimes — a rare species of dimension travelers.', note: 'Rare. Speakers are themselves rare.' },
  { id: 'harabarum', name: 'Harabarum', family: 'Colossi', description: 'Language of the colossi.', note: 'Spoken by giants — pitch + scale make it hard for smaller throats.' }
];
 ...
 */
export function languagePickEligibility(
  lang: LanguageDef,
  lifeForm: LifeForm,
  d3Unlocked: boolean,
  picked: number
